...
urlpatterns = [
    ...
    url(r'^profile/excludedwords/$', 'app.views.profile.excluded_words', name='excluded_words'),
    ...
    url(r'^api/profile/excludedwords/add/$', 'app.views.api.profile.excludedwords.add'),
    url(r'^api/profile/excludedwords/exists/$', 'app.views.api.profile.excludedwords.exists'),
    url(r'^api/profile/excludedwords/lists/$', 'app.views.api.profile.excludedwords.lists'),
